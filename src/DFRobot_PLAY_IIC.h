 ...
 *@version  V1.1
 *@date  2021-10-15
 *@url https://github.com/DFRobot/DFRobot_PLAY
*/


#ifndef DFROBOT_PLAY_IIC_H
#define DFROBOT_PLAY_IIC_H
...
public:
  ...
  DFRobot_PLAY_IIC(TwoWire *pWire = &Wire, uint8_t address = 0x1f);
  //~DFRobot_PLAY_IIC();
  /**
   * @fn begin
   * @brief init function
